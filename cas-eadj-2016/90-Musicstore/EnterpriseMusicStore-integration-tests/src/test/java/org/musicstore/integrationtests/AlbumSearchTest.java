...
//        albumRepository = (AlbumRepository) jndi.lookup("java:global/EnterpriseMusicStore/EnterpriseMusicStore-ejb/AlbumRepository!org.musicstore.repositories.AlbumRepository");
        albumRepository = (AlbumRepository) jndi.lookup("org.musicstore.repositories.AlbumRepository");
    }
